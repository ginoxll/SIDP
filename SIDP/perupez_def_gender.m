    ...
    NSString *cadtmp0 = [@"pkGender = '" stringByAppendingString:pkGender];
                NSString *cad0 = [cadtmp0 stringByAppendingString:@"',"];
                NSString *cadtmp1 = [@"sunatCode = '" stringByAppendingString:sunatCode];
                NSString *cadtmp11 = [cadtmp1 stringByAppendingString:@"',"];
                NSString *cad1 = [cad0 stringByAppendingString:cadtmp11];
                NSString *cadtmp2 = [@"genderName = '" stringByAppendingString:genderName];
    ...
    - (int) delDb{
	Conexion* conx = [[Conexion alloc] init];
	int res = [conx Borrar:@"pkGender" valor:pkGender nombreTabla:@"perupez_def_gender"];
	return res;
    }
