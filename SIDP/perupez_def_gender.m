    ...
    #import 'perupez_def_gender.h'
    @implementation perupez_def_gender
    - (int) set_pkGender : (NSString *)nuevo_valor{
            self.pkGender = nuevo_valor;
            return 1;
        }
        
        - (NSString*) get_pkGender{
            return self.pkGender;
        }
    ...
    NSString *cad0 = [self.pkGender stringByAppendingString:@","];
            NSString *cadtmp1 = [cad0 stringByAppendingString:self.sunatCode];
                ...
                NSString *cadtmp2 = [cad1 stringByAppendingString:self.genderName];
                ...
                NSString *cadsql = cad4;int res = [conx Insertar:@"pkGender,sunatCode,genderName,registrationDate,statusRegister" valores:cadsql nombreTabla:@"perupez_def_gender" ];
    return res;
    }- (int) modDB{
    Conexion *conx = [[Conexion alloc] init];
    NSString *cadBase = @"ALTER TABLE perupez_def_gender SET ";
    NSString *cadtmp0 = [@"pkGender = '" stringByAppendingString:self.pkGender];
                NSString *cad0 = [cadtmp0 stringByAppendingString:@"',"];
                NSString *cadtmp1 = [@"sunatCode = '" stringByAppendingString:self.sunatCode];
                NSString *cadtmp11 = [cadtmp1 stringByAppendingString:@"',"];
                NSString *cad1 = [cad0 stringByAppendingString:cadtmp11];
                NSString *cadtmp2 = [@"genderName = '" stringByAppendingString:self.genderName];
    ...
    NSString *cadBase4 [cadBase3 stringByAppendingString:self.pkGender];
    ...
    - (int) delDb{
	Conexion *conx = [[Conexion alloc] init];
	int res = [conx Borrar:@"pkGender" valor:self.pkGender nombreTabla:@"perupez_def_gender"];
	return res;
    }
    ...
    NSString *cadBase2 [cadBase stringByAppendingString:self.pkGender];
    NSString *cadBase3 @"' ";
