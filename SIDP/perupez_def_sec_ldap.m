    ...
    @implementation perupez_def_sec_ldap
    ...
    NSString *cad0 = [pkPerson stringByAppendingString:@","];
            NSString *cadtmp1 = [cad0 stringByAppendingString:userLogin];
                NSString *cad1 = [cadtmp1 stringByAppendingString:@","];
                NSString *cadtmp2 = [cad1 stringByAppendingString:userPassword];
                ...
                NSString *cadsql = cad4;int res = [conx Insertar:@"pkPerson,userLogin,userPassword,registrationDate,statusRegister" valores:cadsql nombreTabla:@"perupez_def_sec_ldap" ];
    return res;
    }- (int) modDB{
    Conexion* conx = [[Conexion alloc] init];
    NSString *cadBase = @"ALTER TABLE perupez_def_sec_ldap SET ";
    NSString *cadtmp0 = [@"pkPerson = '" stringByAppendingString:pkPerson];
                NSString *cad0 = [cadtmp0 stringByAppendingString:@"',"];
                NSString *cadtmp1 = [@"userLogin = '" stringByAppendingString:userLogin];
                NSString *cadtmp11 = [cadtmp1 stringByAppendingString:@"',"];
                NSString *cad1 = [cad0 stringByAppendingString:cadtmp11];
                NSString *cadtmp2 = [@"userPassword = '" stringByAppendingString:userPassword];
    ...
    - (int) delDb{
	Conexion* conx = [[Conexion alloc] init];
	int res = [conx Borrar:@"pkPerson" valor:pkPerson nombreTabla:@"perupez_def_sec_ldap"];
	return res;
    }
    - (NSMutableArray*) allDB{
	Conexion* conx = [[Conexion alloc] init];
	sqlite3_stmt *res = [conx ListaDB:@"perupez_def_sec_ldap"];
    ...
    NSString *cadBase1 = @"Select * from perupez_def_sec_ldap where pkPerson = '";
    NSString *cadBase2 = [cadBase1 stringByAppendingString:pkPerson];
    NSString *cadBase3 = @"' ";
	...
	Conexion* conx = [[Conexion alloc] init];
	NSString *sql1 = @"Select * from perupez_def_sec_ldap WHERE ";
