    ...
    NSString *cad0 = [self.pkPerson stringByAppendingString:@","];
            NSString *cadtmp1 = [cad0 stringByAppendingString:self.userLogin];
                NSString *cad1 = [cadtmp1 stringByAppendingString:@","];
                NSString *cadtmp2 = [cad1 stringByAppendingString:self.userPassword];
    ...
    NSString *cadtmp0 = [@"pkPerson = '" stringByAppendingString:self.pkPerson];
                ...
                NSString *cadtmp1 = [@"userLogin = '" stringByAppendingString:self.userLogin];
                NSString *cadtmp11 = [cadtmp1 stringByAppendingString:@"',"];
                NSString *cad1 = [cad0 stringByAppendingString:cadtmp11];
                NSString *cadtmp2 = [@"userPassword = '" stringByAppendingString:self.userPassword];
    ...
    - (int) delDb{
	Conexion *conx = [[Conexion alloc] init];
	int res = [conx Borrar:@"pkPerson" valor:self.pkPerson nombreTabla:@"perupez_def_sec_ldap"];
	return res;
    }
