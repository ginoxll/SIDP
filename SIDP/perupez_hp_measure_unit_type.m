    ...
    - (int) set_pkMeasureUnitType : (NSString *)nuevo_valor{
            self.pkMeasureUnitType = nuevo_valor;
            return 1;
        }
        
        - (NSString*) get_pkMeasureUnitType{
            return self.pkMeasureUnitType;
        }
        
        - (int) set_measureUnitTypeName : (NSString *)nuevo_valor{
            self.measureUnitTypeName = nuevo_valor;
            return 1;
        }
        
        - (NSString*) get_measureUnitTypeName{
            return self.measureUnitTypeName;
        }
    ...
    NSString *cad0 = [self.pkMeasureUnitType stringByAppendingString:@","];
            NSString *cadtmp1 = [cad0 stringByAppendingString:self.measureUnitTypeName];
    ...
    NSString *cadtmp0 = [@"pkMeasureUnitType = '" stringByAppendingString:self.pkMeasureUnitType];
                NSString *cad0 = [cadtmp0 stringByAppendingString:@"',"];
                NSString *cadtmp1 = [@"measureUnitTypeName = '" stringByAppendingString:self.measureUnitTypeName];
    ...
    NSString *cadBase4 [cadBase3 stringByAppendingString:self.pkMeasureUnitType];
    ...
    - (int) delDb{
	Conexion *conx = [[Conexion alloc] init];
	int res = [conx Borrar:@"pkMeasureUnitType" valor:self.pkMeasureUnitType nombreTabla:@"perupez_hp_measure_unit_type"];
	return res;
    }
    ...
    NSString *cadBase2 [cadBase stringByAppendingString:self.pkMeasureUnitType];
    NSString *cadBase3 @"' ";
