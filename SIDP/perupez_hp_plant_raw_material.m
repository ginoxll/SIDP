    ...
    #import 'perupez_hp_plant_raw_material.h'
    @implementation perupez_hp_plant_raw_material
    - (int) set_pkPlantRawMaterial : (NSString *)nuevo_valor{
            self.pkPlantRawMaterial = nuevo_valor;
            return 1;
        }
        
        - (NSString*) get_pkPlantRawMaterial{
            return self.pkPlantRawMaterial;
        }
    ...
    NSString *cad0 = [self.pkPlantRawMaterial stringByAppendingString:@","];
            NSString *cadtmp1 = [cad0 stringByAppendingString:self.fkPlant];
                ...
                NSString *cadsql = cad4;int res = [conx Insertar:@"pkPlantRawMaterial,fkPlant,fkRawMaterial,registrationDate,statusRegister" valores:cadsql nombreTabla:@"perupez_hp_plant_raw_material" ];
    return res;
    }- (int) modDB{
    Conexion *conx = [[Conexion alloc] init];
    NSString *cadBase = @"ALTER TABLE perupez_hp_plant_raw_material SET ";
    NSString *cadtmp0 = [@"pkPlantRawMaterial = '" stringByAppendingString:self.pkPlantRawMaterial];
    ...
    NSString *cadBase3 = @" WHERE pkPlantRawMaterial = '";
    NSString *cadBase4 [cadBase3 stringByAppendingString:self.pkPlantRawMaterial];
    ...
    - (int) delDb{
	Conexion *conx = [[Conexion alloc] init];
	int res = [conx Borrar:@"pkPlantRawMaterial" valor:self.pkPlantRawMaterial nombreTabla:@"perupez_hp_plant_raw_material"];
	return res;
    }
    - (NSMutableArray*) allDB{
	Conexion *conx = [[Conexion alloc] init];
	sqlite3_stmt *res = [conx ListaDB:@"perupez_hp_plant_raw_material"];
    ...
    NSString *cadBase1 = @"Select * from perupez_hp_plant_raw_material where pkPlantRawMaterial = '";
    NSString *cadBase2 [cadBase stringByAppendingString:self.pkPlantRawMaterial];
    NSString *cadBase3 @"' ";
	...
	Conexion *conx = [[Conexion alloc] init];
	NSString *sql1 = "Select * from perupez_hp_plant_raw_material WHERE ";
