    ...
    - (int) set_pkPlantRawMaterial : (NSString *)nuevo_valor{
            pkPlantRawMaterial = nuevo_valor;
            return 1;
        }
        
        - (NSString*) get_pkPlantRawMaterial{
            return pkPlantRawMaterial;
        }
    ...
    NSString *cadtmp0 = [@"pkPlantRawMaterial = '" stringByAppendingString:pkPlantRawMaterial];
    ...
    NSString *cadBase4 [cadBase3 stringByAppendingString:pkPlantRawMaterial];
    ...
    - (int) delDb{
	Conexion* conx = [[Conexion alloc] init];
	int res = [conx Borrar:@"pkPlantRawMaterial" valor:pkPlantRawMaterial nombreTabla:@"perupez_hp_plant_raw_material"];
	return res;
    }
    ...
    NSString *cadBase2 [cadBase stringByAppendingString:pkPlantRawMaterial];
    NSString *cadBase3 @"' ";
