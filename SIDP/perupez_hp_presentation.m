    ...
    - (int) set_pkPresentation : (NSString *)nuevo_valor{
            self.pkPresentation = nuevo_valor;
            return 1;
        }
        
        - (NSString*) get_pkPresentation{
            return self.pkPresentation;
        }
        ...
        - (int) set_presentationName : (NSString *)nuevo_valor{
            self.presentationName = nuevo_valor;
            return 1;
        }
    ...
    NSString *cad0 = [self.pkPresentation stringByAppendingString:@","];
            NSString *cadtmp1 = [cad0 stringByAppendingString:self.fkProduct];
                ...
                NSString *cadtmp2 = [cad1 stringByAppendingString:self.presentationName];
    ...
    NSString *cadtmp0 = [@"pkPresentation = '" stringByAppendingString:self.pkPresentation];
                NSString *cad0 = [cadtmp0 stringByAppendingString:@"',"];
                NSString *cadtmp1 = [@"fkProduct = '" stringByAppendingString:self.fkProduct];
                NSString *cadtmp11 = [cadtmp1 stringByAppendingString:@"',"];
                NSString *cad1 = [cad0 stringByAppendingString:cadtmp11];
                NSString *cadtmp2 = [@"presentationName = '" stringByAppendingString:self.presentationName];
    ...
    NSString *cadBase4 [cadBase3 stringByAppendingString:self.pkPresentation];
    ...
    - (int) delDb{
	Conexion *conx = [[Conexion alloc] init];
	int res = [conx Borrar:@"pkPresentation" valor:self.pkPresentation nombreTabla:@"perupez_hp_presentation"];
	return res;
    }
    ...
    NSString *cadBase2 [cadBase stringByAppendingString:self.pkPresentation];
    NSString *cadBase3 @"' ";
