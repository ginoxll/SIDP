...
- (NSMutableArray*) getList
{
    ...
    return [obj getArrayAsociativeOfRecords:@"select * from perupez_hp_raw_material where statusRegister = 1"];
}
        
        - (int) insertDB{
    Conexion* conx = [[Conexion alloc] init];
    NSString *cad0 = [pkRawMaterial stringByAppendingString:@","];
            NSString *cadtmp1 = [cad0 stringByAppendingString:fkSpecies];
                NSString *cad1 = [cadtmp1 stringByAppendingString:@","];
                NSString *cadtmp2 = [cad1 stringByAppendingString:rawMaterialName];
    ...
    NSString *cadtmp0 = [@"pkRawMaterial = '" stringByAppendingString:pkRawMaterial];
                NSString *cad0 = [cadtmp0 stringByAppendingString:@"',"];
                NSString *cadtmp1 = [@"fkSpecies = '" stringByAppendingString:fkSpecies];
                NSString *cadtmp11 = [cadtmp1 stringByAppendingString:@"',"];
                NSString *cad1 = [cad0 stringByAppendingString:cadtmp11];
                NSString *cadtmp2 = [@"rawMaterialName = '" stringByAppendingString:rawMaterialName];
    ...
    NSString *cadBase4 = [cadBase3 stringByAppendingString:pkRawMaterial];
    ...
    - (int) delDb{
	Conexion* conx = [[Conexion alloc] init];
	int res = [conx Borrar:@"pkRawMaterial" valor:pkRawMaterial nombreTabla:@"perupez_hp_raw_material"];
	return res;
    }
    ...
    NSString *cadBase2 = [cadBase1 stringByAppendingString:pkRawMaterial];
    NSString *cadBase3 = @"' ";
