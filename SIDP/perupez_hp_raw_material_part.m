    ...
    - (int) set_pkRawMaterialPart : (NSString *)nuevo_valor{
            self.pkRawMaterialPart = nuevo_valor;
            return 1;
        }
        
        - (NSString*) get_pkRawMaterialPart{
            return self.pkRawMaterialPart;
        }
        ...
        - (int) set_rawMaterialPartName : (NSString *)nuevo_valor{
            self.rawMaterialPartName = nuevo_valor;
            return 1;
        }
        
        - (NSString*) get_rawMaterialPartName{
            return self.rawMaterialPartName;
        }
    ...
    NSString *cad0 = [self.pkRawMaterialPart stringByAppendingString:@","];
            NSString *cadtmp1 = [cad0 stringByAppendingString:self.fkRawMaterial];
                NSString *cad1 = [cadtmp1 stringByAppendingString:@","];
                NSString *cadtmp2 = [cad1 stringByAppendingString:self.rawMaterialPartName];
    ...
    NSString *cadtmp0 = [@"pkRawMaterialPart = '" stringByAppendingString:self.pkRawMaterialPart];
                NSString *cad0 = [cadtmp0 stringByAppendingString:@"',"];
                NSString *cadtmp1 = [@"fkRawMaterial = '" stringByAppendingString:self.fkRawMaterial];
                NSString *cadtmp11 = [cadtmp1 stringByAppendingString:@"',"];
                NSString *cad1 = [cad0 stringByAppendingString:cadtmp11];
                NSString *cadtmp2 = [@"rawMaterialPartName = '" stringByAppendingString:self.rawMaterialPartName];
    ...
    NSString *cadBase4 [cadBase3 stringByAppendingString:self.pkRawMaterialPart];
    ...
    - (int) delDb{
	Conexion *conx = [[Conexion alloc] init];
	int res = [conx Borrar:@"pkRawMaterialPart" valor:self.pkRawMaterialPart nombreTabla:@"perupez_hp_raw_material_part"];
	return res;
    }
    ...
    NSString *cadBase2 [cadBase stringByAppendingString:self.pkRawMaterialPart];
    NSString *cadBase3 @"' ";
