    ...
    - (int) set_pkReceptionActivity : (NSString *)nuevo_valor{
            self.pkReceptionActivity = nuevo_valor;
            return 1;
        }
        
        - (NSString*) get_pkReceptionActivity{
            return self.pkReceptionActivity;
        }
        ...
        - (int) set_fkActivity : (NSString *)nuevo_valor{
            self.fkActivity = nuevo_valor;
            return 1;
        }
        
        - (NSString*) get_fkActivity{
            return self.fkActivity;
        }
    ...
    NSString *cad0 = [self.pkReceptionActivity stringByAppendingString:@","];
            NSString *cadtmp1 = [cad0 stringByAppendingString:self.fkReception];
                ...
                NSString *cadtmp2 = [cad1 stringByAppendingString:self.fkActivity];
    ...
    NSString *cadtmp0 = [@"pkReceptionActivity = '" stringByAppendingString:self.pkReceptionActivity];
                NSString *cad0 = [cadtmp0 stringByAppendingString:@"',"];
                NSString *cadtmp1 = [@"fkReception = '" stringByAppendingString:self.fkReception];
                NSString *cadtmp11 = [cadtmp1 stringByAppendingString:@"',"];
                NSString *cad1 = [cad0 stringByAppendingString:cadtmp11];
                NSString *cadtmp2 = [@"fkActivity = '" stringByAppendingString:self.fkActivity];
    ...
    NSString *cadBase4 [cadBase3 stringByAppendingString:self.pkReceptionActivity];
    ...
    - (int) delDb{
	Conexion *conx = [[Conexion alloc] init];
	int res = [conx Borrar:@"pkReceptionActivity" valor:self.pkReceptionActivity nombreTabla:@"perupez_hp_reception_activity"];
	return res;
    }
    ...
    NSString *cadBase2 [cadBase stringByAppendingString:self.pkReceptionActivity];
    NSString *cadBase3 @"' ";
