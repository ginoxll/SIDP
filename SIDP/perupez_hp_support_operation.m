    ...
    NSString *cad0 = [pkSupportOperation stringByAppendingString:@","];
            NSString *cadtmp1 = [cad0 stringByAppendingString:supportOperationName];
                NSString *cad1 = [cadtmp1 stringByAppendingString:@","];
                NSString *cadtmp2 = [cad1 stringByAppendingString:supportOperationDescription];
    ...
    NSString *cadtmp0 = [@"pkSupportOperation = '" stringByAppendingString:pkSupportOperation];
                NSString *cad0 = [cadtmp0 stringByAppendingString:@"',"];
                NSString *cadtmp1 = [@"supportOperationName = '" stringByAppendingString:supportOperationName];
                NSString *cadtmp11 = [cadtmp1 stringByAppendingString:@"',"];
                NSString *cad1 = [cad0 stringByAppendingString:cadtmp11];
                NSString *cadtmp2 = [@"supportOperationDescription = '" stringByAppendingString:supportOperationDescription];
    ...
    NSString *cadBase4 = [cadBase3 stringByAppendingString:pkSupportOperation];
    ...
    - (int) delDb{
	Conexion* conx = [[Conexion alloc] init];
	int res = [conx Borrar:@"pkSupportOperation" valor:pkSupportOperation nombreTabla:@"perupez_hp_support_operation"];
	return res;
    }
    ...
    NSString *cadBase2 = [cadBase stringByAppendingString:pkSupportOperation];
    NSString *cadBase3 = @"' ";
